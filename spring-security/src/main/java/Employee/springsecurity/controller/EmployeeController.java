package Employee.springsecurity.controller;
...
import Employee.springsecurity.service.EmployeeService;
...
public class EmployeeController {
	...
	public String welcome(
			...
			@RequestParam(required = false) String field, @RequestParam(required = false) String dir, Model model) {
	...
	public String updateEmployee(Integer id, String name, Integer mobileNo, String emailId, String position,
			String manager, String action) {

		if (action.equals("update"))
			service.updateEmployee(id, name, mobileNo, emailId, position, manager);
		else
